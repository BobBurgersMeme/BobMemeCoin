...
// CoinJoin target balance is stored as a signed int in settings/UI, so keep the
// cap below INT_MAX on large-supply forks to avoid overflow.
static constexpr int MAX_COINJOIN_AMOUNT = 2000000000;
