...
const char * const BITCOIN_CONF_FILENAME = "bobmemecoin.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\BobMemeCoin
    // macOS: ~/Library/Application Support/BobMemeCoin
    // Unix-like: ~/.bobmemecoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BobMemeCoin";
#else
    fs::path pathRet;
...
#ifdef __APPLE__
    // macOS
    return pathRet / "Library/Application Support/BobMemeCoin";
#else
    // Unix-like
    return pathRet / ".bobmemecoin";
#endif
#endif
}
