...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BobMemeCoin address"));
    ...
    coinJoinCoinsAction->setStatusTip(tr("Send %1 funds to a BobMemeCoin address").arg(strCoinJoinName));
    coinJoinCoinsAction->setToolTip(coinJoinCoinsAction->statusTip());

    receiveCoinsAction = new QAction(tr("&Receive"), this);
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bobmemecoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BobMemeCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BobMemeCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a bobmemecoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible BobMemeCoin command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (fNetworkActive) {
        ...
        tooltip = tr("%n active connection(s) to BobMemeCoin network", "", count);
    } else {
