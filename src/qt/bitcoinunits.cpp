...
QString BitcoinUnits::name(Unit unit)
{
    ...
    switch (unit) {
    case Unit::SMT:  return is_mainnet ? QString("BMC") : QString("tBMC");
    case Unit::mDASH: return is_mainnet ? QString("mBMC") : QString("mtBMC");
    case Unit::uDASH: return is_mainnet ? QString("uBMC") : QString("utBMC");
    case Unit::duffs: return is_mainnet ? QString("atoms") : QString("tatoms");
...
{
    const QString coin_name{Params().NetworkIDString() == CBaseChainParams::MAIN ? "BobMemeCoin" : "Test BobMemeCoin"};
    switch (unit) {
