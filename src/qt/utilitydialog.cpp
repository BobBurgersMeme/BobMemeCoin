    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString bmcFooter = "<br><br>"
            "<b>" + tr("BobMemeCoin build") + "</b><br>"
            + tr("This wallet is configured as a BobMemeCoin fork.") + "<br>"
            + tr("Project website") + ": <a style=\"" + linkStyle + "\" href=\"https://bobmeme.com\">bobmeme.com</a>";

        text = version + "\n" + QString::fromStdString(FormatParagraph(licenseInfo));
        ui->aboutMessage->setText(version + "<br><br>" + licenseInfoHTML + bmcFooter);
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    } else if (helpMode == cmdline) {
        setWindowTitle(tr("Command-line options"));
        QString header = "Usage: bobmemecoin-qt [command-line options] [URI]\n\n"
                         "Optional URI is a BobMemeCoin address in BIP21 URI format.\n";
...
All the BobMemeCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 BMC, 0.01 BMC, 0.1 BMC, 1 BMC and 10 BMC -- sort of like the paper money you use every day.</li> \
