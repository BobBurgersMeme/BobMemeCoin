...
{
    const char* pszTimestamp = "BobMemeCoin genesis 2026-04-20 - BobMeme starts here";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x000002f1a3005fe448ad3c7ca0ed7457ad91d0c8a5b123fe29ec50ad1977f76d");
        ...
        nDefaultPort = 36661;
        nDefaultPlatformP2PPort = 36671;
        nDefaultPlatformHTTPPort = 36672;
        nPruneAfterHeight = 100000;
        m_assumed_blockchain_size = 0;
        m_assumed_chain_state_size = 1;

        genesis = CreateGenesisBlock(1776686400, 19050, 0x1e3fffff, 1, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000002f1a3005fe448ad3c7ca0ed7457ad91d0c8a5b123fe29ec50ad1977f76d"));
        assert(genesis.hashMerkleRoot == uint256S("0xaabef75628f1030deab85d071c4396adae033c598331381209ff1062c5ed22fe"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = {0x04, 0x69, 0xD6};
        ...
        consensus.nSMTSmallQuorumsHeight = 2;
        ...
        vSporkAddresses = {"bbcejE7LxLSiXcbVpaPrrRffyZXWN3U5Q5am"};
        nMinSporkKeys = 1;
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("0x00003e301aa2618b4fc4ef2f77574d7de9f97e0f73275ebc262b855114eed82e");
        consensus.BIP65Height = 0;
        consensus.BIP66Height = 0;
        consensus.BIP147Height = 0;
        consensus.CSVHeight = 0;
        ...
        nDefaultPort = 37661;
        nDefaultPlatformP2PPort = 37671;
        nDefaultPlatformHTTPPort = 37672;
        nPruneAfterHeight = 1000;
        m_assumed_blockchain_size = 0;
        m_assumed_chain_state_size = 1;

        genesis = CreateGenesisBlock(1776686520, 18938, 0x1e3fffff, 1, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00003e301aa2618b4fc4ef2f77574d7de9f97e0f73275ebc262b855114eed82e"));
        assert(genesis.hashMerkleRoot == uint256S("0xaabef75628f1030deab85d071c4396adae033c598331381209ff1062c5ed22fe"));
        ...
        // BobMemeCoin addresses start with 'bbc'
        base58Prefixes[PUBKEY_ADDRESS] = {0x04, 0x69, 0xD6};
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        nDefaultPort = 38661;
        nDefaultPlatformP2PPort = 38671;
        nDefaultPlatformHTTPPort = 38672;
        nPruneAfterHeight = 1000;
        m_assumed_blockchain_size = 0;
        m_assumed_chain_state_size = 0;

        UpdateDevnetSubsidyAndDiffParametersFromArgs(args);
        genesis = CreateGenesisBlock(1776686520, 0, 0x207fffff, 1, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1ad8f76be8c90de42452d390cb6e8200746100f6f5abdda1a961f776c473112c"));
        assert(genesis.hashMerkleRoot == uint256S("0xaabef75628f1030deab85d071c4396adae033c598331381209ff1062c5ed22fe"));
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        nDefaultPort = 39661;
        nDefaultPlatformP2PPort = 39671;
        nDefaultPlatformHTTPPort = 39672;
        ...
        genesis = CreateGenesisBlock(1776686580, 0, 0x207fffff, 1, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6d17bac96c3cd9a52221d1f7306a48a55fa780ebe056081d2083791abce30369"));
        assert(genesis.hashMerkleRoot == uint256S("0xaabef75628f1030deab85d071c4396adae033c598331381209ff1062c5ed22fe"));
