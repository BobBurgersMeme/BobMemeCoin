...
static RPCHelpMan debug()
{
    return RPCHelpMan{"debug",
        ...
        " - \"bobmemecoin\" activates all BobMemeCoin-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "bobmemecoin")
    + HelpExampleRpc("debug", "bobmemecoin+net")
        },
...
static RPCHelpMan logging()
{
    return RPCHelpMan{"logging",
            ...
            + HelpExampleCli("logging", "'[\"bobmemecoin\"]' '[\"llmq\",\"zmq\"]'")
...
static RPCHelpMan echo(const std::string& name)
{
    return RPCHelpMan{name,
                ...
                "bobmemecoin-cli and the GUI. There is no server-side difference.",
        {
    ...
    return RPCHelpMan{
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue {
            ...
            if (interfaces::Ipc* ipc = local_init.ipc()) {
                ...
                auto init = ipc->spawnProcess("bobmemecoin-node");
                echo = init->makeEcho();
...
{ //  category              actor (function)
  //  --------------------- ------------------------
    ...
    /* BobMemeCoin features */
    { "bobmemecoin",               &mnsync,                  },
    { "bobmemecoin",               &spork,                   },
    { "bobmemecoin",               &sporkupdate,             },
