...
static RPCHelpMan masternodelist_helper(bool is_composite)
{
    ...
    return RPCHelpMan{is_composite ? "masternode list" : "masternodelist",
        ...
        "  owneraddress   - Print the masternode owner BobMemeCoin address\n"
        "  payee          - Print the masternode payout BobMemeCoin address (can be additionally filtered,\n"
        "                   partial match)\n"
        "  pubKeyOperator - Print the masternode operator public key\n"
        "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
        "                   (can be additionally filtered, partial match)\n"
        "  votingaddress  - Print the masternode voting BobMemeCoin address\n",
        {
        ...
        RPCResult{
            RPCResult::Type::OBJ, "<outpoint>", "", {
                ...
                RPCResult{"for mode = payee", RPCResult::Type::STR, "<addr>", "BobMemeCoin address used for masternode reward payments"},
                RPCResult{"for mode = owneraddress", RPCResult::Type::STR, "<addr>", "BobMemeCoin address used for payee updates and proposal voting"},
                ...
                RPCResult{"for mode = votingaddress", RPCResult::Type::STR, "<addr>", "BobMemeCoin address used for voting"},
            }
        },
        RPCExamples{""},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
...
Span<const CRPCCommand> GetWalletMasternodeRPCCommands()
{
    static const CRPCCommand commands[]{
        {"bobmemecoin", &masternode_outputs},
    };
    return commands;
}
#endif // ENABLE_WALLET
...
{
    static const CRPCCommand commands[]{
        {"bobmemecoin", &masternode_help},
        {"bobmemecoin", &masternodelist_composite},
        {"bobmemecoin", &masternodelist},
        {"bobmemecoin", &masternode_connect},
        {"bobmemecoin", &masternode_count},
        {"bobmemecoin", &masternode_status},
        {"bobmemecoin", &masternode_payments},
        {"bobmemecoin", &masternode_winners},
    };
