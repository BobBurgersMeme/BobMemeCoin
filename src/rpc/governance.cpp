...
Span<const CRPCCommand> GetWalletGovernanceRPCCommands()
{
    static const CRPCCommand commands[]{
        {"bobmemecoin", &gobject_prepare},
        {"bobmemecoin", &gobject_list_prepared},
        {"bobmemecoin", &gobject_vote_many},
        {"bobmemecoin", &gobject_vote_alias},
    };
    return commands;
}
#endif // ENABLE_WALLET
...
{
    static const CRPCCommand commands[]{
        {"bobmemecoin", &getgovernanceinfo},
        {"bobmemecoin", &getsuperblockbudget},
        {"bobmemecoin", &gobject},
        {"bobmemecoin", &gobject_count},
        {"bobmemecoin", &gobject_deserialize},
        {"bobmemecoin", &gobject_check},
        {"bobmemecoin", &gobject_submit},
        {"bobmemecoin", &gobject_list},
        {"bobmemecoin", &gobject_diff},
        {"bobmemecoin", &gobject_get},
        {"bobmemecoin", &gobject_getcurrentvotes},
        {"bobmemecoin", &voteraw},
    };
