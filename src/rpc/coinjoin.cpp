// Copyright (c) 2019-2025 The BobMemeCoin Core developers
...
Span<const CRPCCommand> GetWalletCoinJoinRPCCommands()
{
    static const CRPCCommand commands[]{
        {"bobmemecoin", &coinjoin},
        {"bobmemecoin", &coinjoin_reset},
        {"bobmemecoin", &coinjoin_start},
        {"bobmemecoin", &coinjoin_status},
        {"bobmemecoin", &coinjoin_stop},
        {"bobmemecoin", &coinjoinsalt},
        {"bobmemecoin", &coinjoinsalt_generate},
        {"bobmemecoin", &coinjoinsalt_get},
        {"bobmemecoin", &coinjoinsalt_set},
        {"bobmemecoin", &getcoinjoininfo},
    };
    return commands;
}
#endif // ENABLE_WALLET
