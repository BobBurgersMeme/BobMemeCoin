...
const std::string EXAMPLE_ADDRESS[2] = {"bbcLvmagg7uTSubwSqS1ouNPeaXXkgTjiFiC", "bbcNV1WkxjpU9NC2zJqJu4LQ8hSENUdaEHu9"};
...
{
    return "> bobmemecoin-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleCliNamed(const std::string& methodname, const RPCArgList& args)
{
    std::string result = "> bobmemecoin-cli -named " + methodname;
